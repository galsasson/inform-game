...
{
	this.materials.white = new THREE.MeshLambertMaterial( { color: 0xffffff, ambient: 0x888888 } );
	...
	this.materials.character = new THREE.MeshPhongMaterial( { ambient: 0x820505, specular: 0xff0000, shininess: 50 } );
	// this.materials.character.shading = THREE.FlatShading;
